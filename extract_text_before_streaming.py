...
def main():
    ...
    with open(f'debates_all_{date_range}.csv','w',newline='',encoding='utf-8') as f:
        w=csv.DictWriter(f,fieldnames=fields)
        w.writeheader()
        w.writerows(all_rows)

# C:\Users\josep\VS-code-projects\Oireachtas_Collect_Analyse\Oireachtas_XML_2015-01-01_to_2020-01-01.xml
